...
public class ParseLoginFragment extends ParseLoginFragmentBase {
  ...
  private static final String USER_OBJECT_NAME_FIELD = "name";
    private static final String USER_PBJECT_ID_FIELD = "id";
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup parent,
    ...
    facebookLoginButton = (ImageButton) v.findViewById(R.id.facebook_login);
                    ...
                    public void onCompleted(GraphUser fbUser,
                      ...
                      */
                      ...
                      if (fbUser != null && parseUser != null
                        ...
                        Log.e("facebookユーザー","user=" + fbUser.getInnerJSONObject());
                          try {
                              facebookId = fbUser.getInnerJSONObject().getString(USER_PBJECT_ID_FIELD);
                          } catch (JSONException e1) {
                              e1.printStackTrace();
                          }
                          parseUser.put(USER_OBJECT_NAME_FIELD, fbUser.getName());
                          parseUser.put(USER_PBJECT_ID_FIELD,facebookId);
