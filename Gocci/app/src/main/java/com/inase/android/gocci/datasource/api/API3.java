    ...
    class Util {
        ...
        public static String SetRestLocalCodeMessageTable(SetRestLocalCode code) {
            if (SetRestLocalCodeMap.isEmpty()) {
                SetRestLocalCodeMap.put(SetRestLocalCode.ERROR_RESPONSE_REST_ID_MISSING, "Response 'rest_id' was not received");
                ...
                SetRestLocalCodeMap.put(SetRestLocalCode.ERROR_RESPONSE_REST_ID_MALFORMED, "Response 'rest_id' is malformed. Should correspond to '^\\d{1,9}$'");
