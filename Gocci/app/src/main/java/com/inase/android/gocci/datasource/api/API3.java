    ...
    class Util {
        ...
        public static String SetFollowLocalCodeMessageTable(SetFollowLocalCode code) {
            if (SetFollowLocalCodeMap.isEmpty()) {
                ...
                SetFollowLocalCodeMap.put(SetFollowLocalCode.ERROR_PARAMETER_USER_ID_MALFORMED, "Parameter 'user_id' is malformed. Should correspond to '^\\d{1,12}$'");
            }
            String message = null;
        ...
        public static String SetCommentLocalCodeMessageTable(SetCommentLocalCode code) {
            if (SetCommentLocalCodeMap.isEmpty()) {
                SetCommentLocalCodeMap.put(SetCommentLocalCode.ERROR_PARAMETER_RE_USER_ID_MALFORMED, "Parameter 're_user_id' is malformed. Should correspond to '^\\d{1,12}$'");
                SetCommentLocalCodeMap.put(SetCommentLocalCode.ERROR_PARAMETER_POST_ID_MALFORMED, "Parameter 'post_id' is malformed. Should correspond to '^\\d{1,12}$'");
        ...
        public static String SetBlockLocalCodeMessageTable(SetBlockLocalCode code) {
            if (SetBlockLocalCodeMap.isEmpty()) {
                SetBlockLocalCodeMap.put(SetBlockLocalCode.ERROR_PARAMETER_POST_ID_MALFORMED, "Parameter 'post_id' is malformed. Should correspond to '^\\d{1,12}$'");
        ...
        public static String SetGochiLocalCodeMessageTable(SetGochiLocalCode code) {
            if (SetGochiLocalCodeMap.isEmpty()) {
                SetGochiLocalCodeMap.put(SetGochiLocalCode.ERROR_PARAMETER_POST_ID_MALFORMED, "Parameter 'post_id' is malformed. Should correspond to '^\\d{1,12}$'");
        ...
        public static String SetWantLocalCodeMessageTable(SetWantLocalCode code) {
            if (SetWantLocalCodeMap.isEmpty()) {
                SetWantLocalCodeMap.put(SetWantLocalCode.ERROR_PARAMETER_REST_ID_MALFORMED, "Parameter 'rest_id' is malformed. Should correspond to '^\\d{1,12}$'");
        ...
        public static String SetPostLocalCodeMessageTable(SetPostLocalCode code) {
            if (SetPostLocalCodeMap.isEmpty()) {
                SetPostLocalCodeMap.put(SetPostLocalCode.ERROR_PARAMETER_REST_ID_MALFORMED, "Parameter 'rest_id' is malformed. Should correspond to '^\\d{1,12}$'");
        ...
        public static String GetFollowlineLocalCodeMessageTable(GetFollowlineLocalCode code) {
            if (GetFollowlineLocalCodeMap.isEmpty()) {
                GetFollowlineLocalCodeMap.put(GetFollowlineLocalCode.ERROR_RESPONSE_POSTS_POST_ID_MALFORMED, "Response 'post_id' is malformed. Should correspond to '^\\d{1,12}$'");
                ...
                GetFollowlineLocalCodeMap.put(GetFollowlineLocalCode.ERROR_RESPONSE_POSTS_USER_ID_MALFORMED, "Response 'user_id' is malformed. Should correspond to '^\\d{1,12}$'");
                ...
                GetFollowlineLocalCodeMap.put(GetFollowlineLocalCode.ERROR_RESPONSE_POSTS_REST_ID_MALFORMED, "Response 'rest_id' is malformed. Should correspond to '^\\d{1,12}$'");
        ...
        public static String GetFollowLocalCodeMessageTable(GetFollowLocalCode code) {
            if (GetFollowLocalCodeMap.isEmpty()) {
                ...
                GetFollowLocalCodeMap.put(GetFollowLocalCode.ERROR_PARAMETER_USER_ID_MALFORMED, "Parameter 'user_id' is malformed. Should correspond to '^\\d{1,12}$'");
                ...
                GetFollowLocalCodeMap.put(GetFollowLocalCode.ERROR_RESPONSE_USERS_USER_ID_MALFORMED, "Response 'user_id' is malformed. Should correspond to '^\\d{1,12}$'");
        ...
        public static String GetFollowerLocalCodeMessageTable(GetFollowerLocalCode code) {
            if (GetFollowerLocalCodeMap.isEmpty()) {
                ...
                GetFollowerLocalCodeMap.put(GetFollowerLocalCode.ERROR_PARAMETER_USER_ID_MALFORMED, "Parameter 'user_id' is malformed. Should correspond to '^\\d{1,12}$'");
                ...
                GetFollowerLocalCodeMap.put(GetFollowerLocalCode.ERROR_RESPONSE_USERS_USER_ID_MALFORMED, "Response 'user_id' is malformed. Should correspond to '^\\d{1,12}$'");
        ...
        public static String GetRestLocalCodeMessageTable(GetRestLocalCode code) {
            if (GetRestLocalCodeMap.isEmpty()) {
                ...
                GetRestLocalCodeMap.put(GetRestLocalCode.ERROR_RESPONSE_POSTS_POST_REST_ID_MALFORMED, "Response 'post_rest_id' is malformed. Should correspond to '^\\d{1,12}$'");
                GetRestLocalCodeMap.put(GetRestLocalCode.ERROR_RESPONSE_POSTS_USER_ID_MALFORMED, "Response 'user_id' is malformed. Should correspond to '^\\d{1,12}$'");
                ...
                GetRestLocalCodeMap.put(GetRestLocalCode.ERROR_PARAMETER_REST_ID_MALFORMED, "Parameter 'rest_id' is malformed. Should correspond to '^\\d{1,12}$'");
                ...
                GetRestLocalCodeMap.put(GetRestLocalCode.ERROR_RESPONSE_REST_REST_ID_MALFORMED, "Response 'rest_id' is malformed. Should correspond to '^\\d{1,12}$'");
                ...
                GetRestLocalCodeMap.put(GetRestLocalCode.ERROR_RESPONSE_POSTS_POST_ID_MALFORMED, "Response 'post_id' is malformed. Should correspond to '^\\d{1,12}$'");
        ...
        public static String GetCommentLocalCodeMessageTable(GetCommentLocalCode code) {
            if (GetCommentLocalCodeMap.isEmpty()) {
                ...
                GetCommentLocalCodeMap.put(GetCommentLocalCode.ERROR_PARAMETER_POST_ID_MALFORMED, "Parameter 'post_id' is malformed. Should correspond to '^\\d{1,12}$'");
                ...
                GetCommentLocalCodeMap.put(GetCommentLocalCode.ERROR_RESPONSE_MEMO_USER_ID_MALFORMED, "Response 'user_id' is malformed. Should correspond to '^\\d{1,12}$'");
                ...
                GetCommentLocalCodeMap.put(GetCommentLocalCode.ERROR_RESPONSE_COMMENTS_COMMENT_ID_MALFORMED, "Response 'comment_id' is malformed. Should correspond to '^\\d{1,12}$'");
                ...
                GetCommentLocalCodeMap.put(GetCommentLocalCode.ERROR_RESPONSE_COMMENTS_COMMENT_USER_ID_MALFORMED, "Response 'comment_user_id' is malformed. Should correspond to '^\\d{1,12}$'");
                ...
                GetCommentLocalCodeMap.put(GetCommentLocalCode.ERROR_RESPONSE_COMMENTS_RE_USERS_USER_ID_MALFORMED, "Response 'user_id' is malformed. Should correspond to '^\\d{1,12}$'");
        ...
        public static String GetHeatmapLocalCodeMessageTable(GetHeatmapLocalCode code) {
            if (GetHeatmapLocalCodeMap.isEmpty()) {
                ...
                GetHeatmapLocalCodeMap.put(GetHeatmapLocalCode.ERROR_RESPONSE_RESTS_POST_REST_ID_MALFORMED, "Response 'post_rest_id' is malformed. Should correspond to '^\\d{1,12}$'");
        ...
        public static String GetNoticeLocalCodeMessageTable(GetNoticeLocalCode code) {
            if (GetNoticeLocalCodeMap.isEmpty()) {
                GetNoticeLocalCodeMap.put(GetNoticeLocalCode.ERROR_RESPONSE_NOTICES_NOTICE_ID_MALFORMED, "Response 'notice_id' is malformed. Should correspond to '^\\d{1,12}$'");
                ...
                GetNoticeLocalCodeMap.put(GetNoticeLocalCode.ERROR_RESPONSE_NOTICES_NOTICE_POST_ID_MALFORMED, "Response 'notice_post_id' is malformed. Should correspond to '^\\d{1,12}$'");
                GetNoticeLocalCodeMap.put(GetNoticeLocalCode.ERROR_RESPONSE_NOTICES_USER_ID_MALFORMED, "Response 'user_id' is malformed. Should correspond to '^\\d{1,12}$'");
        ...
        public static String GetUser_CheerLocalCodeMessageTable(GetUser_CheerLocalCode code) {
            if (GetUser_CheerLocalCodeMap.isEmpty()) {
                ...
                GetUser_CheerLocalCodeMap.put(GetUser_CheerLocalCode.ERROR_PARAMETER_USER_ID_MALFORMED, "Parameter 'user_id' is malformed. Should correspond to '^\\d{1,12}$'");
                ...
                GetUser_CheerLocalCodeMap.put(GetUser_CheerLocalCode.ERROR_RESPONSE_RESTS_REST_ID_MALFORMED, "Response 'rest_id' is malformed. Should correspond to '^\\d{1,12}$'");
        ...
        public static String GetNearlineLocalCodeMessageTable(GetNearlineLocalCode code) {
            if (GetNearlineLocalCodeMap.isEmpty()) {
                ...
                GetNearlineLocalCodeMap.put(GetNearlineLocalCode.ERROR_RESPONSE_POSTS_USER_ID_MALFORMED, "Response 'user_id' is malformed. Should correspond to '^\\d{1,12}$'");
                GetNearlineLocalCodeMap.put(GetNearlineLocalCode.ERROR_RESPONSE_POSTS_POST_ID_MALFORMED, "Response 'post_id' is malformed. Should correspond to '^\\d{1,12}$'");
                ...
                GetNearlineLocalCodeMap.put(GetNearlineLocalCode.ERROR_RESPONSE_POSTS_REST_ID_MALFORMED, "Response 'rest_id' is malformed. Should correspond to '^\\d{1,12}$'");
            }
            String message = null;
        ...
        public static String GetWantLocalCodeMessageTable(GetWantLocalCode code) {
            if (GetWantLocalCodeMap.isEmpty()) {
                ...
                GetWantLocalCodeMap.put(GetWantLocalCode.ERROR_PARAMETER_USER_ID_MALFORMED, "Parameter 'user_id' is malformed. Should correspond to '^\\d{1,12}$'");
                ...
                GetWantLocalCodeMap.put(GetWantLocalCode.ERROR_RESPONSE_RESTS_REST_ID_MALFORMED, "Response 'rest_id' is malformed. Should correspond to '^\\d{1,12}$'");
        ...
        public static String GetUserLocalCodeMessageTable(GetUserLocalCode code) {
            if (GetUserLocalCodeMap.isEmpty()) {
                ...
                GetUserLocalCodeMap.put(GetUserLocalCode.ERROR_RESPONSE_USER_USER_ID_MALFORMED, "Response 'user_id' is malformed. Should correspond to '^\\d{1,12}$'");
                ...
                GetUserLocalCodeMap.put(GetUserLocalCode.ERROR_PARAMETER_USER_ID_MALFORMED, "Parameter 'user_id' is malformed. Should correspond to '^\\d{1,12}$'");
                ...
                GetUserLocalCodeMap.put(GetUserLocalCode.ERROR_RESPONSE_POSTS_POST_ID_MALFORMED, "Response 'post_id' is malformed. Should correspond to '^\\d{1,12}$'");
                ...
                GetUserLocalCodeMap.put(GetUserLocalCode.ERROR_RESPONSE_POSTS_REST_ID_MALFORMED, "Response 'rest_id' is malformed. Should correspond to '^\\d{1,12}$'");
        ...
        public static String GetNearLocalCodeMessageTable(GetNearLocalCode code) {
            if (GetNearLocalCodeMap.isEmpty()) {
                ...
                GetNearLocalCodeMap.put(GetNearLocalCode.ERROR_RESPONSE_RESTS_REST_ID_MALFORMED, "Response 'rest_id' is malformed. Should correspond to '^\\d{1,12}$'");
        ...
        public static String GetTimelineLocalCodeMessageTable(GetTimelineLocalCode code) {
            if (GetTimelineLocalCodeMap.isEmpty()) {
                GetTimelineLocalCodeMap.put(GetTimelineLocalCode.ERROR_RESPONSE_POSTS_POST_ID_MALFORMED, "Response 'post_id' is malformed. Should correspond to '^\\d{1,12}$'");
                ...
                GetTimelineLocalCodeMap.put(GetTimelineLocalCode.ERROR_RESPONSE_POSTS_USER_ID_MALFORMED, "Response 'user_id' is malformed. Should correspond to '^\\d{1,12}$'");
                ...
                GetTimelineLocalCodeMap.put(GetTimelineLocalCode.ERROR_RESPONSE_POSTS_REST_ID_MALFORMED, "Response 'rest_id' is malformed. Should correspond to '^\\d{1,12}$'");
        ...
        public static String GetRest_CheerLocalCodeMessageTable(GetRest_CheerLocalCode code) {
            if (GetRest_CheerLocalCodeMap.isEmpty()) {
                GetRest_CheerLocalCodeMap.put(GetRest_CheerLocalCode.ERROR_PARAMETER_REST_ID_MALFORMED, "Parameter 'rest_id' is malformed. Should correspond to '^\\d{1,12}$'");
                ...
                GetRest_CheerLocalCodeMap.put(GetRest_CheerLocalCode.ERROR_RESPONSE_RESTS_REST_ID_MALFORMED, "Response 'rest_id' is malformed. Should correspond to '^\\d{1,12}$'");
        ...
        public static String AuthLoginLocalCodeMessageTable(AuthLoginLocalCode code) {
            if (AuthLoginLocalCodeMap.isEmpty()) {
                ...
                AuthLoginLocalCodeMap.put(AuthLoginLocalCode.ERROR_RESPONSE_USER_ID_MALFORMED, "Response 'user_id' is malformed. Should correspond to '^[0-9]{1,12}$'");
        ...
        public static String UnsetFollowLocalCodeMessageTable(UnsetFollowLocalCode code) {
            if (UnsetFollowLocalCodeMap.isEmpty()) {
                ...
                UnsetFollowLocalCodeMap.put(UnsetFollowLocalCode.ERROR_PARAMETER_USER_ID_MALFORMED, "Parameter 'user_id' is malformed. Should correspond to '^\\d{1,12}$'");
            }
            String message = null;
        ...
        public static String UnsetWantLocalCodeMessageTable(UnsetWantLocalCode code) {
            if (UnsetWantLocalCodeMap.isEmpty()) {
                UnsetWantLocalCodeMap.put(UnsetWantLocalCode.ERROR_PARAMETER_REST_ID_MALFORMED, "Parameter 'rest_id' is malformed. Should correspond to '^\\d{1,12}$'");
        ...
        public static String UnsetPostLocalCodeMessageTable(UnsetPostLocalCode code) {
            if (UnsetPostLocalCodeMap.isEmpty()) {
                UnsetPostLocalCodeMap.put(UnsetPostLocalCode.ERROR_PARAMETER_POST_ID_MALFORMED, "Parameter 'post_id' is malformed. Should correspond to '^\\d{1,12}$'");
