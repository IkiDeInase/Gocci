...
public interface API3 {
    ...
    class Util {
        ...
        public enum GetFollower_RankLocalCode {
            ...
            ERROR_RESPONSE_USERS_GOCHI_NUM_MISSING,
            ERROR_RESPONSE_USERS_GOCHI_NUM_MALFORMED,
            ERROR_RESPONSE_USERS_FOLLOWER_NUM_MISSING,
            ERROR_RESPONSE_USERS_FOLLOWER_NUM_MALFORMED,
            ERROR_RESPONSE_USERS_POST_NUM_MISSING,
            ERROR_RESPONSE_USERS_POST_NUM_MALFORMED,
            ERROR_RESPONSE_USERS_PROFILE_IMG_MISSING,
            ERROR_RESPONSE_USERS_PROFILE_IMG_MALFORMED,
            ERROR_RESPONSE_USERS_USER_ID_MISSING,
            ERROR_RESPONSE_USERS_USER_ID_MALFORMED,
        ...
        public static String GetFollower_RankLocalCodeMessageTable(GetFollower_RankLocalCode code) {
            if (GetFollower_RankLocalCodeMap.isEmpty()) {
                ...
                GetFollower_RankLocalCodeMap.put(GetFollower_RankLocalCode.ERROR_RESPONSE_USERS_POST_NUM_MISSING, Application_Gocci.getInstance().getApplicationContext().getString(R.string.GetFollower_RankLocalCode_ERROR_RESPONSE_USERS_POST_NUM_MISSING));
                ...
                GetFollower_RankLocalCodeMap.put(GetFollower_RankLocalCode.ERROR_RESPONSE_USERS_POST_NUM_MALFORMED, Application_Gocci.getInstance().getApplicationContext().getString(R.string.GetFollower_RankLocalCode_ERROR_RESPONSE_USERS_POST_NUM_MALFORMED));
                ...
                GetFollower_RankLocalCodeMap.put(GetFollower_RankLocalCode.ERROR_RESPONSE_USERS_FOLLOWER_NUM_MISSING, Application_Gocci.getInstance().getApplicationContext().getString(R.string.GetFollower_RankLocalCode_ERROR_RESPONSE_USERS_FOLLOWER_NUM_MISSING));
                ...
                GetFollower_RankLocalCodeMap.put(GetFollower_RankLocalCode.ERROR_RESPONSE_USERS_FOLLOWER_NUM_MALFORMED, Application_Gocci.getInstance().getApplicationContext().getString(R.string.GetFollower_RankLocalCode_ERROR_RESPONSE_USERS_FOLLOWER_NUM_MALFORMED));
        ...
        public static GetFollower_RankLocalCode GetFollower_RankLocalCodeReverseLookupTable(String message) {
            if (GetFollower_RankLocalCodeReverseMap.isEmpty()) {
                ...
                GetFollower_RankLocalCodeReverseMap.put("ERROR_RESPONSE_USERS_POST_NUM_MISSING", GetFollower_RankLocalCode.ERROR_RESPONSE_USERS_POST_NUM_MISSING);
                ...
                GetFollower_RankLocalCodeReverseMap.put("ERROR_RESPONSE_USERS_POST_NUM_MALFORMED", GetFollower_RankLocalCode.ERROR_RESPONSE_USERS_POST_NUM_MALFORMED);
                ...
                GetFollower_RankLocalCodeReverseMap.put("ERROR_RESPONSE_USERS_FOLLOWER_NUM_MISSING", GetFollower_RankLocalCode.ERROR_RESPONSE_USERS_FOLLOWER_NUM_MISSING);
                ...
                GetFollower_RankLocalCodeReverseMap.put("ERROR_RESPONSE_USERS_FOLLOWER_NUM_MALFORMED", GetFollower_RankLocalCode.ERROR_RESPONSE_USERS_FOLLOWER_NUM_MALFORMED);
        ...
        public static String GetRest_CheerLocalCodeMessageTable(GetRest_CheerLocalCode code) {
            if (GetRest_CheerLocalCodeMap.isEmpty()) {
                GetRest_CheerLocalCodeMap.put(GetRest_CheerLocalCode.ERROR_RESPONSE_USERS_USERNAME_MALFORMED, Application_Gocci.getInstance().getApplicationContext().getString(R.string.GetRest_CheerLocalCode_ERROR_RESPONSE_USERS_USERNAME_MALFORMED));
                GetRest_CheerLocalCodeMap.put(GetRest_CheerLocalCode.ERROR_RESPONSE_USERS_GOCHI_NUM_MALFORMED, Application_Gocci.getInstance().getApplicationContext().getString(R.string.GetRest_CheerLocalCode_ERROR_RESPONSE_USERS_GOCHI_NUM_MALFORMED));
                ...
                GetRest_CheerLocalCodeMap.put(GetRest_CheerLocalCode.ERROR_RESPONSE_USERS_FOLLOW_FLAG_MISSING, Application_Gocci.getInstance().getApplicationContext().getString(R.string.GetRest_CheerLocalCode_ERROR_RESPONSE_USERS_FOLLOW_FLAG_MISSING));
                GetRest_CheerLocalCodeMap.put(GetRest_CheerLocalCode.ERROR_RESPONSE_PAYLOAD_MISSING, Application_Gocci.getInstance().getApplicationContext().getString(R.string.GetRest_CheerLocalCode_ERROR_RESPONSE_PAYLOAD_MISSING));
                GetRest_CheerLocalCodeMap.put(GetRest_CheerLocalCode.ERROR_RESPONSE_USERS_PROFILE_IMG_MISSING, Application_Gocci.getInstance().getApplicationContext().getString(R.string.GetRest_CheerLocalCode_ERROR_RESPONSE_USERS_PROFILE_IMG_MISSING));
                GetRest_CheerLocalCodeMap.put(GetRest_CheerLocalCode.ERROR_RESPONSE_USERS_USER_ID_MISSING, Application_Gocci.getInstance().getApplicationContext().getString(R.string.GetRest_CheerLocalCode_ERROR_RESPONSE_USERS_USER_ID_MISSING));
                GetRest_CheerLocalCodeMap.put(GetRest_CheerLocalCode.ERROR_RESPONSE_USERS_PROFILE_IMG_MALFORMED, Application_Gocci.getInstance().getApplicationContext().getString(R.string.GetRest_CheerLocalCode_ERROR_RESPONSE_USERS_PROFILE_IMG_MALFORMED));
                ...
                GetRest_CheerLocalCodeMap.put(GetRest_CheerLocalCode.ERROR_RESPONSE_USERS_GOCHI_NUM_MISSING, Application_Gocci.getInstance().getApplicationContext().getString(R.string.GetRest_CheerLocalCode_ERROR_RESPONSE_USERS_GOCHI_NUM_MISSING));
                GetRest_CheerLocalCodeMap.put(GetRest_CheerLocalCode.ERROR_RESPONSE_USERS_FOLLOW_FLAG_MALFORMED, Application_Gocci.getInstance().getApplicationContext().getString(R.string.GetRest_CheerLocalCode_ERROR_RESPONSE_USERS_FOLLOW_FLAG_MALFORMED));
                GetRest_CheerLocalCodeMap.put(GetRest_CheerLocalCode.ERROR_RESPONSE_USERS_USERNAME_MISSING, Application_Gocci.getInstance().getApplicationContext().getString(R.string.GetRest_CheerLocalCode_ERROR_RESPONSE_USERS_USERNAME_MISSING));
                GetRest_CheerLocalCodeMap.put(GetRest_CheerLocalCode.ERROR_RESPONSE_USERS_USER_ID_MALFORMED, Application_Gocci.getInstance().getApplicationContext().getString(R.string.GetRest_CheerLocalCode_ERROR_RESPONSE_USERS_USER_ID_MALFORMED));
                GetRest_CheerLocalCodeMap.put(GetRest_CheerLocalCode.ERROR_RESPONSE_USERS_MISSING, Application_Gocci.getInstance().getApplicationContext().getString(R.string.GetRest_CheerLocalCode_ERROR_RESPONSE_USERS_MISSING));
            }
            String message = null;
        ...
        public static GetRest_CheerLocalCode GetRest_CheerLocalCodeReverseLookupTable(String message) {
            if (GetRest_CheerLocalCodeReverseMap.isEmpty()) {
                GetRest_CheerLocalCodeReverseMap.put("ERROR_RESPONSE_USERS_USERNAME_MALFORMED", GetRest_CheerLocalCode.ERROR_RESPONSE_USERS_USERNAME_MALFORMED);
                GetRest_CheerLocalCodeReverseMap.put("ERROR_RESPONSE_USERS_GOCHI_NUM_MALFORMED", GetRest_CheerLocalCode.ERROR_RESPONSE_USERS_GOCHI_NUM_MALFORMED);
                ...
                GetRest_CheerLocalCodeReverseMap.put("ERROR_RESPONSE_USERS_FOLLOW_FLAG_MISSING", GetRest_CheerLocalCode.ERROR_RESPONSE_USERS_FOLLOW_FLAG_MISSING);
                GetRest_CheerLocalCodeReverseMap.put("ERROR_RESPONSE_PAYLOAD_MISSING", GetRest_CheerLocalCode.ERROR_RESPONSE_PAYLOAD_MISSING);
                GetRest_CheerLocalCodeReverseMap.put("ERROR_RESPONSE_USERS_PROFILE_IMG_MISSING", GetRest_CheerLocalCode.ERROR_RESPONSE_USERS_PROFILE_IMG_MISSING);
                GetRest_CheerLocalCodeReverseMap.put("ERROR_RESPONSE_USERS_USER_ID_MISSING", GetRest_CheerLocalCode.ERROR_RESPONSE_USERS_USER_ID_MISSING);
                GetRest_CheerLocalCodeReverseMap.put("ERROR_RESPONSE_USERS_PROFILE_IMG_MALFORMED", GetRest_CheerLocalCode.ERROR_RESPONSE_USERS_PROFILE_IMG_MALFORMED);
                ...
                GetRest_CheerLocalCodeReverseMap.put("ERROR_RESPONSE_USERS_GOCHI_NUM_MISSING", GetRest_CheerLocalCode.ERROR_RESPONSE_USERS_GOCHI_NUM_MISSING);
                GetRest_CheerLocalCodeReverseMap.put("ERROR_RESPONSE_USERS_FOLLOW_FLAG_MALFORMED", GetRest_CheerLocalCode.ERROR_RESPONSE_USERS_FOLLOW_FLAG_MALFORMED);
                GetRest_CheerLocalCodeReverseMap.put("ERROR_RESPONSE_USERS_USERNAME_MISSING", GetRest_CheerLocalCode.ERROR_RESPONSE_USERS_USERNAME_MISSING);
                GetRest_CheerLocalCodeReverseMap.put("ERROR_RESPONSE_USERS_USER_ID_MALFORMED", GetRest_CheerLocalCode.ERROR_RESPONSE_USERS_USER_ID_MALFORMED);
                GetRest_CheerLocalCodeReverseMap.put("ERROR_RESPONSE_USERS_MISSING", GetRest_CheerLocalCode.ERROR_RESPONSE_USERS_MISSING);
            }
