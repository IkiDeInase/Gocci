...
public interface API3 {
    ...
    Util.GetHeatmapLocalCode GetHeatmapParameterRegex(String user_id);
    ...
    class Util {
        ...
        public static String GetWantLocalCodeMessageTable(GetWantLocalCode code) {
            if (GetWantLocalCodeMap.isEmpty()) {
                ...
                GetWantLocalCodeMap.put(GetWantLocalCode.ERROR_RESPONSE_PAYLOAD_MISSING, Application_Gocci.getInstance().getApplicationContext().getString(R.string.GetWantLocalCode_ERROR_RESPONSE_PAYLOAD_MISSING));
            }
            String message = null;
        ...
        public static GetWantLocalCode GetWantLocalCodeReverseLookupTable(String message) {
            if (GetWantLocalCodeReverseMap.isEmpty()) {
                ...
                GetWantLocalCodeReverseMap.put("ERROR_RESPONSE_PAYLOAD_MISSING", GetWantLocalCode.ERROR_RESPONSE_PAYLOAD_MISSING);
            }
        ...
        public static String getGetHeatmapAPI(String user_id) {
            StringBuilder url = new StringBuilder(testurl + "/get/heatmap/");
            if (user_id != null) url.append("&user_id=").append(user_id);
            return url.toString().replace("/&", "/?");
        }
        ...
        public static String GetHeatmapLocalCodeMessageTable(GetHeatmapLocalCode code) {
            if (GetHeatmapLocalCodeMap.isEmpty()) {
                ...
                GetHeatmapLocalCodeMap.put(GetHeatmapLocalCode.ERROR_PARAMETER_USER_ID_MALFORMED, Application_Gocci.getInstance().getApplicationContext().getString(R.string.GetHeatmapLocalCode_ERROR_PARAMETER_USER_ID_MALFORMED));
        ...
        public static GetHeatmapLocalCode GetHeatmapLocalCodeReverseLookupTable(String message) {
            if (GetHeatmapLocalCodeReverseMap.isEmpty()) {
                ...
                GetHeatmapLocalCodeReverseMap.put("ERROR_PARAMETER_USER_ID_MALFORMED", GetHeatmapLocalCode.ERROR_PARAMETER_USER_ID_MALFORMED);
        ...
        public static String UnsetWantLocalCodeMessageTable(UnsetWantLocalCode code) {
            if (UnsetWantLocalCodeMap.isEmpty()) {
                ...
                UnsetWantLocalCodeMap.put(UnsetWantLocalCode.ERROR_RESPONSE_PAYLOAD_MISSING, Application_Gocci.getInstance().getApplicationContext().getString(R.string.UnsetWantLocalCode_ERROR_RESPONSE_PAYLOAD_MISSING));
            }
            String message = null;
        ...
        public static UnsetWantLocalCode UnsetWantLocalCodeReverseLookupTable(String message) {
            if (UnsetWantLocalCodeReverseMap.isEmpty()) {
                ...
                UnsetWantLocalCodeReverseMap.put("ERROR_RESPONSE_PAYLOAD_MISSING", UnsetWantLocalCode.ERROR_RESPONSE_PAYLOAD_MISSING);
            }
        ...
        public static String SetWantLocalCodeMessageTable(SetWantLocalCode code) {
            if (SetWantLocalCodeMap.isEmpty()) {
                ...
                SetWantLocalCodeMap.put(SetWantLocalCode.ERROR_RESPONSE_PAYLOAD_MISSING, Application_Gocci.getInstance().getApplicationContext().getString(R.string.SetWantLocalCode_ERROR_RESPONSE_PAYLOAD_MISSING));
            }
            String message = null;
        ...
        public static SetWantLocalCode SetWantLocalCodeReverseLookupTable(String message) {
            if (SetWantLocalCodeReverseMap.isEmpty()) {
                ...
                SetWantLocalCodeReverseMap.put("ERROR_RESPONSE_PAYLOAD_MISSING", SetWantLocalCode.ERROR_RESPONSE_PAYLOAD_MISSING);
            }
    ...
    class Impl implements API3 {
        ...
        @Override
        public Util.GetHeatmapLocalCode GetHeatmapParameterRegex(String user_id) {
            if (user_id != null) {
                if (!user_id.matches("^\\d{1,9}$")) {
                    return Util.GetHeatmapLocalCode.ERROR_PARAMETER_USER_ID_MALFORMED;
                }
            }
            return null;
        }
