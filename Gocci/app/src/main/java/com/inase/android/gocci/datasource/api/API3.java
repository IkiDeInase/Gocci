...
public interface API3 {
    ...
    class Util {
        ...
        public enum GetCommentLocalCode {
            ...
            ERROR_RESPONSE_COMMENTS_RE_USER_ID_MISSING,
            ERROR_RESPONSE_COMMENTS_RE_USER_ID_USER_ID_MISSING,
            ERROR_RESPONSE_COMMENTS_RE_USER_ID_USER_ID_MALFORMED,
            ERROR_RESPONSE_COMMENTS_RE_USER_ID_USERNAME_MISSING,
            ERROR_RESPONSE_COMMENTS_RE_USER_ID_USERNAME_MALFORMED,
        ...
        public static String GetCommentLocalCodeMessageTable(GetCommentLocalCode code) {
            if (GetCommentLocalCodeMap.isEmpty()) {
                GetCommentLocalCodeMap.put(GetCommentLocalCode.ERROR_RESPONSE_COMMENTS_COMMENT_USER_ID_MALFORMED, "Response 'comment_user_id' is malformed. Should correspond to '^\\d+$'");
                GetCommentLocalCodeMap.put(GetCommentLocalCode.ERROR_RESPONSE_COMMENTS_COMMENT_MALFORMED, "Response 'comment' is malformed. Should correspond to '^\\S{1,140}$'");
                ...
                GetCommentLocalCodeMap.put(GetCommentLocalCode.ERROR_RESPONSE_COMMENTS_RE_USER_ID_USERNAME_MISSING, "Response 'username' was not received");
                ...
                GetCommentLocalCodeMap.put(GetCommentLocalCode.ERROR_RESPONSE_MEMO_USERNAME_MALFORMED, "Response 'username' is malformed. Should correspond to '^[\\S]{2,20}$'");
                ...
                GetCommentLocalCodeMap.put(GetCommentLocalCode.ERROR_RESPONSE_COMMENTS_RE_USER_ID_USERNAME_MALFORMED, "Response 'username' is malformed. Should correspond to '^[\\S]{2,20}$'");
                GetCommentLocalCodeMap.put(GetCommentLocalCode.ERROR_RESPONSE_MEMO_USER_ID_MISSING, "Response 'user_id' was not received");
                GetCommentLocalCodeMap.put(GetCommentLocalCode.ERROR_RESPONSE_MEMO_USER_ID_MALFORMED, "Response 'user_id' is malformed. Should correspond to '^\\d+$'");
                ...
                GetCommentLocalCodeMap.put(GetCommentLocalCode.ERROR_RESPONSE_MEMO_PROFILE_IMG_MALFORMED, "Response 'profile_img' is malformed. Should correspond to '^[0-9_-]+$'");
                ...
                GetCommentLocalCodeMap.put(GetCommentLocalCode.ERROR_RESPONSE_COMMENTS_PROFILE_IMG_MALFORMED, "Response 'profile_img' is malformed. Should correspond to '^[0-9_-]+$'");
                GetCommentLocalCodeMap.put(GetCommentLocalCode.ERROR_RESPONSE_COMMENTS_RE_USER_ID_USER_ID_MALFORMED, "Response 'user_id' is malformed. Should correspond to '^\\d+$'");
                GetCommentLocalCodeMap.put(GetCommentLocalCode.ERROR_RESPONSE_COMMENTS_USERNAME_MALFORMED, "Response 'username' is malformed. Should correspond to '^[\\S]{2,20}$'");
                GetCommentLocalCodeMap.put(GetCommentLocalCode.ERROR_PARAMETER_POST_ID_MISSING, "Parameter 'post_id' does not exist.");
                GetCommentLocalCodeMap.put(GetCommentLocalCode.ERROR_RESPONSE_COMMENTS_RE_USER_ID_USER_ID_MISSING, "Response 'user_id' was not received");
                ...
                GetCommentLocalCodeMap.put(GetCommentLocalCode.ERROR_RESPONSE_COMMENTS_COMMENT_ID_MALFORMED, "Response 'comment_id' is malformed. Should correspond to '^\\d+$'");
                GetCommentLocalCodeMap.put(GetCommentLocalCode.ERROR_RESPONSE_MEMO_USERNAME_MISSING, "Response 'username' was not received");
                GetCommentLocalCodeMap.put(GetCommentLocalCode.ERROR_RESPONSE_COMMENTS_RE_USER_ID_MISSING, "Response 're_user_id' was not received");
            }
            String message = null;
        ...
        public static GetCommentLocalCode GetCommentLocalCodeReverseLookupTable(String message) {
            if (GetCommentLocalCodeReverseMap.isEmpty()) {
                ...
                GetCommentLocalCodeReverseMap.put("ERROR_RESPONSE_COMMENTS_RE_USER_ID_USERNAME_MISSING", GetCommentLocalCode.ERROR_RESPONSE_COMMENTS_RE_USER_ID_USERNAME_MISSING);
                ...
                GetCommentLocalCodeReverseMap.put("ERROR_RESPONSE_COMMENTS_RE_USER_ID_USERNAME_MALFORMED", GetCommentLocalCode.ERROR_RESPONSE_COMMENTS_RE_USER_ID_USERNAME_MALFORMED);
                ...
                GetCommentLocalCodeReverseMap.put("ERROR_RESPONSE_COMMENTS_RE_USER_ID_USER_ID_MALFORMED", GetCommentLocalCode.ERROR_RESPONSE_COMMENTS_RE_USER_ID_USER_ID_MALFORMED);
                ...
                GetCommentLocalCodeReverseMap.put("ERROR_RESPONSE_COMMENTS_RE_USER_ID_USER_ID_MISSING", GetCommentLocalCode.ERROR_RESPONSE_COMMENTS_RE_USER_ID_USER_ID_MISSING);
                ...
                GetCommentLocalCodeReverseMap.put("ERROR_RESPONSE_COMMENTS_RE_USER_ID_MISSING", GetCommentLocalCode.ERROR_RESPONSE_COMMENTS_RE_USER_ID_MISSING);
            }
        ...
        public static String GetRestLocalCodeMessageTable(GetRestLocalCode code) {
            if (GetRestLocalCodeMap.isEmpty()) {
                ...
                GetRestLocalCodeMap.put(GetRestLocalCode.ERROR_RESPONSE_POSTS_USER_ID_MALFORMED, "Response 'user_id' is malformed. Should correspond to '^\\d+$'");
                GetRestLocalCodeMap.put(GetRestLocalCode.ERROR_RESPONSE_POSTS_USERNAME_MISSING, "Response 'username' was not received");
                GetRestLocalCodeMap.put(GetRestLocalCode.ERROR_RESPONSE_REST_RESTNAME_MALFORMED, "Response 'restname' is malformed. Should correspond to '^\\S{2,30}$'");
                ...
                GetRestLocalCodeMap.put(GetRestLocalCode.ERROR_RESPONSE_POSTS_PROFILE_IMG_MALFORMED, "Response 'profile_img' is malformed. Should correspond to '^[0-9_-]+$'");
                ...
                GetRestLocalCodeMap.put(GetRestLocalCode.ERROR_RESPONSE_REST_REST_CATEGORY_MALFORMED, "Response 'rest_category' is malformed. Should correspond to '^$'");
                ...
                GetRestLocalCodeMap.put(GetRestLocalCode.ERROR_RESPONSE_POSTS_POST_REST_ID_MALFORMED, "Response 'post_rest_id' is malformed. Should correspond to '^\\d+$'");
                ...
                GetRestLocalCodeMap.put(GetRestLocalCode.ERROR_RESPONSE_REST_REST_ID_MALFORMED, "Response 'rest_id' is malformed. Should correspond to '^\\d+$'");
                ...
                GetRestLocalCodeMap.put(GetRestLocalCode.ERROR_RESPONSE_POSTS_USERNAME_MALFORMED, "Response 'username' is malformed. Should correspond to '^[\\S]{2,20}$'");
                ...
                GetRestLocalCodeMap.put(GetRestLocalCode.ERROR_RESPONSE_POSTS_POST_ID_MALFORMED, "Response 'post_id' is malformed. Should correspond to '^\\d+$'");
            }
            String message = null;
        ...
        public static String GetTimelineLocalCodeMessageTable(GetTimelineLocalCode code) {
            if (GetTimelineLocalCodeMap.isEmpty()) {
                ...
                GetTimelineLocalCodeMap.put(GetTimelineLocalCode.ERROR_RESPONSE_POSTS_RESTNAME_MALFORMED, "Response 'restname' is malformed. Should correspond to '^\\S{2,30}$'");
                GetTimelineLocalCodeMap.put(GetTimelineLocalCode.ERROR_RESPONSE_POSTS_USER_ID_MALFORMED, "Response 'user_id' is malformed. Should correspond to '^\\d+$'");
                ...
                GetTimelineLocalCodeMap.put(GetTimelineLocalCode.ERROR_RESPONSE_POSTS_REST_ID_MALFORMED, "Response 'rest_id' is malformed. Should correspond to '^\\d+$'");
                ...
                GetTimelineLocalCodeMap.put(GetTimelineLocalCode.ERROR_RESPONSE_POSTS_USERNAME_MALFORMED, "Response 'username' is malformed. Should correspond to '^[\\S]{2,20}$'");
                ...
                GetTimelineLocalCodeMap.put(GetTimelineLocalCode.ERROR_RESPONSE_POSTS_POST_ID_MALFORMED, "Response 'post_id' is malformed. Should correspond to '^\\d+$'");
            }
            String message = null;
        ...
        public static String GetUserLocalCodeMessageTable(GetUserLocalCode code) {
            if (GetUserLocalCodeMap.isEmpty()) {
                ...
                GetUserLocalCodeMap.put(GetUserLocalCode.ERROR_RESPONSE_POSTS_RESTNAME_MALFORMED, "Response 'restname' is malformed. Should correspond to '^\\S{2,30}$'");
                ...
                GetUserLocalCodeMap.put(GetUserLocalCode.ERROR_RESPONSE_USER_USERNAME_MALFORMED, "Response 'username' is malformed. Should correspond to '^[\\S]{2,20}$'");
                ...
                GetUserLocalCodeMap.put(GetUserLocalCode.ERROR_RESPONSE_USER_USER_ID_MALFORMED, "Response 'user_id' is malformed. Should correspond to '^\\d+$'");
                GetUserLocalCodeMap.put(GetUserLocalCode.ERROR_RESPONSE_USER_PROFILE_IMG_MALFORMED, "Response 'profile_img' is malformed. Should correspond to '^[0-9_-]+$'");
                ...
                GetUserLocalCodeMap.put(GetUserLocalCode.ERROR_RESPONSE_POSTS_REST_ID_MALFORMED, "Response 'rest_id' is malformed. Should correspond to '^\\d+$'");
                ...
                GetUserLocalCodeMap.put(GetUserLocalCode.ERROR_RESPONSE_POSTS_POST_ID_MALFORMED, "Response 'post_id' is malformed. Should correspond to '^\\d+$'");
            }
            String message = null;
        ...
        public static String GetNearLocalCodeMessageTable(GetNearLocalCode code) {
            if (GetNearLocalCodeMap.isEmpty()) {
                ...
                GetNearLocalCodeMap.put(GetNearLocalCode.ERROR_RESPONSE_RESTS_REST_ID_MALFORMED, "Response 'rest_id' is malformed. Should correspond to '^\\d+$'");
                GetNearLocalCodeMap.put(GetNearLocalCode.ERROR_RESPONSE_RESTS_RESTNAME_MALFORMED, "Response 'restname' is malformed. Should correspond to '^\\S{2,30}$'");
        ...
        public static String GetRest_CheerLocalCodeMessageTable(GetRest_CheerLocalCode code) {
            if (GetRest_CheerLocalCodeMap.isEmpty()) {
                ...
                GetRest_CheerLocalCodeMap.put(GetRest_CheerLocalCode.ERROR_RESPONSE_RESTS_REST_ID_MALFORMED, "Response 'rest_id' is malformed. Should correspond to '^\\d+$'");
                ...
                GetRest_CheerLocalCodeMap.put(GetRest_CheerLocalCode.ERROR_RESPONSE_RESTS_RESTNAME_MALFORMED, "Response 'restname' is malformed. Should correspond to '^\\S{2,30}$'");
            }
            String message = null;
        ...
        public static String GetFollowLocalCodeMessageTable(GetFollowLocalCode code) {
            if (GetFollowLocalCodeMap.isEmpty()) {
                ...
                GetFollowLocalCodeMap.put(GetFollowLocalCode.ERROR_RESPONSE_USERS_USERNAME_MALFORMED, "Response 'username' is malformed. Should correspond to '^[\\S]{2,20}$'");
                ...
                GetFollowLocalCodeMap.put(GetFollowLocalCode.ERROR_RESPONSE_USERS_PROFILE_IMG_MALFORMED, "Response 'profile_img' is malformed. Should correspond to '^[0-9_-]+$'");
                ...
                GetFollowLocalCodeMap.put(GetFollowLocalCode.ERROR_RESPONSE_USERS_USER_ID_MALFORMED, "Response 'user_id' is malformed. Should correspond to '^\\d+$'");
        ...
        public static String GetFollowerLocalCodeMessageTable(GetFollowerLocalCode code) {
            if (GetFollowerLocalCodeMap.isEmpty()) {
                ...
                GetFollowerLocalCodeMap.put(GetFollowerLocalCode.ERROR_RESPONSE_USERS_USERNAME_MALFORMED, "Response 'username' is malformed. Should correspond to '^[\\S]{2,20}$'");
                ...
                GetFollowerLocalCodeMap.put(GetFollowerLocalCode.ERROR_RESPONSE_USERS_PROFILE_IMG_MALFORMED, "Response 'profile_img' is malformed. Should correspond to '^[0-9_-]+$'");
                ...
                GetFollowerLocalCodeMap.put(GetFollowerLocalCode.ERROR_RESPONSE_USERS_USER_ID_MALFORMED, "Response 'user_id' is malformed. Should correspond to '^\\d+$'");
        ...
        public static String GetUser_CheerLocalCodeMessageTable(GetUser_CheerLocalCode code) {
            if (GetUser_CheerLocalCodeMap.isEmpty()) {
                ...
                GetUser_CheerLocalCodeMap.put(GetUser_CheerLocalCode.ERROR_RESPONSE_RESTS_RESTNAME_MALFORMED, "Response 'restname' is malformed. Should correspond to '^\\S{2,30}$'");
                ...
                GetUser_CheerLocalCodeMap.put(GetUser_CheerLocalCode.ERROR_RESPONSE_RESTS_REST_ID_MALFORMED, "Response 'rest_id' is malformed. Should correspond to '^\\d+$'");
        ...
        public static String GetFollowlineLocalCodeMessageTable(GetFollowlineLocalCode code) {
            if (GetFollowlineLocalCodeMap.isEmpty()) {
                ...
                GetFollowlineLocalCodeMap.put(GetFollowlineLocalCode.ERROR_RESPONSE_POSTS_RESTNAME_MALFORMED, "Response 'restname' is malformed. Should correspond to '^\\S{2,30}$'");
                GetFollowlineLocalCodeMap.put(GetFollowlineLocalCode.ERROR_RESPONSE_POSTS_USER_ID_MALFORMED, "Response 'user_id' is malformed. Should correspond to '^\\d+$'");
                ...
                GetFollowlineLocalCodeMap.put(GetFollowlineLocalCode.ERROR_RESPONSE_POSTS_REST_ID_MALFORMED, "Response 'rest_id' is malformed. Should correspond to '^\\d+$'");
                ...
                GetFollowlineLocalCodeMap.put(GetFollowlineLocalCode.ERROR_RESPONSE_POSTS_USERNAME_MALFORMED, "Response 'username' is malformed. Should correspond to '^[\\S]{2,20}$'");
                ...
                GetFollowlineLocalCodeMap.put(GetFollowlineLocalCode.ERROR_RESPONSE_POSTS_POST_ID_MALFORMED, "Response 'post_id' is malformed. Should correspond to '^\\d+$'");
            }
            String message = null;
        ...
        public static String GetNearlineLocalCodeMessageTable(GetNearlineLocalCode code) {
            if (GetNearlineLocalCodeMap.isEmpty()) {
                ...
                GetNearlineLocalCodeMap.put(GetNearlineLocalCode.ERROR_RESPONSE_POSTS_RESTNAME_MALFORMED, "Response 'restname' is malformed. Should correspond to '^\\S{2,30}$'");
                GetNearlineLocalCodeMap.put(GetNearlineLocalCode.ERROR_RESPONSE_POSTS_USER_ID_MALFORMED, "Response 'user_id' is malformed. Should correspond to '^\\d+$'");
                ...
                GetNearlineLocalCodeMap.put(GetNearlineLocalCode.ERROR_RESPONSE_POSTS_REST_ID_MALFORMED, "Response 'rest_id' is malformed. Should correspond to '^\\d+$'");
                ...
                GetNearlineLocalCodeMap.put(GetNearlineLocalCode.ERROR_RESPONSE_POSTS_USERNAME_MALFORMED, "Response 'username' is malformed. Should correspond to '^[\\S]{2,20}$'");
                ...
                GetNearlineLocalCodeMap.put(GetNearlineLocalCode.ERROR_RESPONSE_POSTS_POST_ID_MALFORMED, "Response 'post_id' is malformed. Should correspond to '^\\d+$'");
            }
            String message = null;
        ...
        public static String GetWantLocalCodeMessageTable(GetWantLocalCode code) {
            if (GetWantLocalCodeMap.isEmpty()) {
                ...
                GetWantLocalCodeMap.put(GetWantLocalCode.ERROR_RESPONSE_RESTS_RESTNAME_MALFORMED, "Response 'restname' is malformed. Should correspond to '^\\S{2,30}$'");
                ...
                GetWantLocalCodeMap.put(GetWantLocalCode.ERROR_RESPONSE_RESTS_REST_ID_MALFORMED, "Response 'rest_id' is malformed. Should correspond to '^\\d+$'");
        ...
        public static String GetNoticeLocalCodeMessageTable(GetNoticeLocalCode code) {
            if (GetNoticeLocalCodeMap.isEmpty()) {
                ...
                GetNoticeLocalCodeMap.put(GetNoticeLocalCode.ERROR_RESPONSE_NOTICES_USER_ID_MALFORMED, "Response 'user_id' is malformed. Should correspond to '^\\d+$'");
                GetNoticeLocalCodeMap.put(GetNoticeLocalCode.ERROR_RESPONSE_NOTICES_USERNAME_MALFORMED, "Response 'username' is malformed. Should correspond to '^[\\S]{2,20}$'");
                GetNoticeLocalCodeMap.put(GetNoticeLocalCode.ERROR_RESPONSE_NOTICES_PROFILE_IMG_MALFORMED, "Response 'profile_img' is malformed. Should correspond to '^[0-9_-]+$'");
                ...
                GetNoticeLocalCodeMap.put(GetNoticeLocalCode.ERROR_RESPONSE_NOTICES_NOTICE_ID_MALFORMED, "Response 'notice_id' is malformed. Should correspond to '^\\d+$'");
                ...
                GetNoticeLocalCodeMap.put(GetNoticeLocalCode.ERROR_RESPONSE_NOTICES_NOTICE_POST_ID_MALFORMED, "Response 'notice_post_id' is malformed. Should correspond to '^\\d+$'");
        ...
        public static String GetHeatmapLocalCodeMessageTable(GetHeatmapLocalCode code) {
            if (GetHeatmapLocalCodeMap.isEmpty()) {
                ...
                GetHeatmapLocalCodeMap.put(GetHeatmapLocalCode.ERROR_RESPONSE_RESTS_RESTNAME_MALFORMED, "Response 'restname' is malformed. Should correspond to '^\\S{2,30}$'");
                GetHeatmapLocalCodeMap.put(GetHeatmapLocalCode.ERROR_RESPONSE_RESTS_LAT_MALFORMED, "Response 'lat' is malformed. Should correspond to '^\\d+.\\d+$'");
                GetHeatmapLocalCodeMap.put(GetHeatmapLocalCode.ERROR_RESPONSE_RESTS_MISSING, "Response 'rests' was not received");
                GetHeatmapLocalCodeMap.put(GetHeatmapLocalCode.ERROR_RESPONSE_RESTS_LON_MALFORMED, "Response 'lon' is malformed. Should correspond to '^\\d+.\\d+$'");
                ...
                GetHeatmapLocalCodeMap.put(GetHeatmapLocalCode.ERROR_RESPONSE_RESTS_POST_REST_ID_MALFORMED, "Response 'post_rest_id' is malformed. Should correspond to '^\\d+$'");
