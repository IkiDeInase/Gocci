    ...
    class Util {
        ...
        public static String GetCommentLocalCodeMessageTable(GetCommentLocalCode code) {
            if (GetCommentLocalCodeMap.isEmpty()) {
                ...
                GetCommentLocalCodeMap.put(GetCommentLocalCode.ERROR_RESPONSE_MEMO_PROFILE_IMG_MALFORMED, "Response 'profile_img' is malformed. Should correspond to '^http\\S+$'");
                ...
                GetCommentLocalCodeMap.put(GetCommentLocalCode.ERROR_RESPONSE_COMMENTS_RE_USERS_USER_ID_MALFORMED, "Response 'user_id' is malformed. Should correspond to '^\\d+$'");
                ...
                GetCommentLocalCodeMap.put(GetCommentLocalCode.ERROR_RESPONSE_COMMENTS_RE_USERS_USERNAME_MALFORMED, "Response 'username' is malformed. Should correspond to '^[\\S]{2,20}$'");
                ...
                GetCommentLocalCodeMap.put(GetCommentLocalCode.ERROR_RESPONSE_COMMENTS_PROFILE_IMG_MALFORMED, "Response 'profile_img' is malformed. Should correspond to '^http\\S+$'");
        ...
        public static String GetRestLocalCodeMessageTable(GetRestLocalCode code) {
            if (GetRestLocalCodeMap.isEmpty()) {
                ...
                GetRestLocalCodeMap.put(GetRestLocalCode.ERROR_RESPONSE_POSTS_PROFILE_IMG_MALFORMED, "Response 'profile_img' is malformed. Should correspond to '^http\\S+$'");
        ...
        public static String GetFollowerLocalCodeMessageTable(GetFollowerLocalCode code) {
            if (GetFollowerLocalCodeMap.isEmpty()) {
                ...
                GetFollowerLocalCodeMap.put(GetFollowerLocalCode.ERROR_RESPONSE_USERS_PROFILE_IMG_MALFORMED, "Response 'profile_img' is malformed. Should correspond to '^http\\S+$'");
        ...
        public static String GetUserLocalCodeMessageTable(GetUserLocalCode code) {
            if (GetUserLocalCodeMap.isEmpty()) {
                ...
                GetUserLocalCodeMap.put(GetUserLocalCode.ERROR_RESPONSE_USER_PROFILE_IMG_MALFORMED, "Response 'profile_img' is malformed. Should correspond to '^http\\S+$'");
        ...
        public static String GetNoticeLocalCodeMessageTable(GetNoticeLocalCode code) {
            if (GetNoticeLocalCodeMap.isEmpty()) {
                ...
                GetNoticeLocalCodeMap.put(GetNoticeLocalCode.ERROR_RESPONSE_NOTICES_PROFILE_IMG_MALFORMED, "Response 'profile_img' is malformed. Should correspond to '^http\\S+$'");
        ...
        public static String GetFollowLocalCodeMessageTable(GetFollowLocalCode code) {
            if (GetFollowLocalCodeMap.isEmpty()) {
                ...
                GetFollowLocalCodeMap.put(GetFollowLocalCode.ERROR_RESPONSE_USERS_PROFILE_IMG_MALFORMED, "Response 'profile_img' is malformed. Should correspond to '^http\\S+$'");
