    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.e("ログ", "通知クリック");
                notificationNumber.setVisibility(View.INVISIBLE);
                SavedData.setNotification(GocciLifelogActivity.this, 0);
                ...
                ToukouPopup.showLikeQuickAction(window, notification, v, GocciLifelogActivity.this.getWindowManager(), 0, 0);
            }
        });
            ...
            new MaterialDialog.Builder(GocciLifelogActivity.this)
                    ...
                    .callback(new MaterialDialog.ButtonCallback() {
                        ...
                        public void onPositive(MaterialDialog dialog) {
                            ...
                            switch (judge) {
                                case "facebook":
                                    ...
                                    if (session != null) {
                                        ...
                                        session = new Session(GocciLifelogActivity.this);
                            ...
                            EventDateRecorder recorder = EventDateRecorder.load(GocciLifelogActivity.this, "use_first_gocci_android");
                            recorder.clear();

                            Intent intent = new Intent(GocciLifelogActivity.this, LoginActivity.class);
